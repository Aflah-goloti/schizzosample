...
const pages = [
  ...
  { name: 'Services', icon: Build, path: '/services' },
...
const StyledAppBar = styled(AppBar)(({ theme }) => ({
  ...
  '&:hover': {
    background: 'linear-gradient(135deg, rgba(255, 255, 255, 0.95) 0%, rgba(168, 168, 168, 0.95) 100%)',
...
const LogoIcon = styled(Box)(({ theme }) => ({
  width: '48px',
  height: '48px',
  background: 'linear-gradient(45deg,rgb(61, 61, 63) 30%,rgb(53, 45, 61) 90%)',
  borderRadius: '12px',
  display: 'flex',
  alignItems: 'center',
...
const NavButton = styled(Button)(({ theme }) => ({
  ...
  '&::before': {
    ...
    width: '0',
    height: '2px',
    background: 'linear-gradient(45deg,rgb(50, 50, 50) 30%, #764ba2 90%)',
    transition: 'all 0.3s ease',
...
function Navbar() {
  ...
  return (
    <StyledAppBar 
      ...
      sx={{
        background: scrolled 
          ? 'linear-gradient(135deg, rgba(255, 255, 255, 0.95) 0%, rgba(193, 193, 193, 0.95) 100%)' 
          : 'transparent',
